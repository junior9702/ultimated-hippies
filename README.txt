...
3. In Vercel > Project Settings > Environment Variables, set:
   PAYHERO_API_USERNAME = Lxtl3MmtloXSqDLyJ4TB
   PAYHERO_API_PASSWORD = 97Av9Nt1NnIdDyCtaq56F9VDjEuYtq8VmEttmbgo
   PAYHERO_CHANNEL_ID = 12910
   PAYHERO_CALLBACK_URL =https://lipwa.link/12405
4. Redeploy after setting environment variables.
5. Test using a low amount and a phone you control.
